    ...
    body: (
      <>
        ...
        <ul>
          ...
          <li>Η φόρμα κλείνει μόνο με <Btn>Κλείσιμο</Btn> — ένα κλικ έξω από αυτήν ή το πλήκτρο <Kbd>Esc</Kbd> δεν την
            κλείνουν, ώστε να μη χάνονται όσα έχετε συμπληρώσει. Το ίδιο ισχύει και στη μαζική καταχώριση.</li>
