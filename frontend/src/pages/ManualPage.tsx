    ...
    body: (
      <>
        ...
        <p>
          ...
          σημειώνεται ως διαγραμμένη και παύει να εμφανίζεται στις αναζητήσεις. Η ερώτηση επιβεβαίωσης
          ακυρώνεται με <Btn>Ακύρωση</Btn>, με κλικ έξω από το παράθυρό της ή με το πλήκτρο <Kbd>Esc</Kbd>.
        </p>
      </>
    ),
  },
