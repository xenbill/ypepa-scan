    ...
    body: (
      <>
        ...
        <table className="manual-table">
          <thead>
            <tr><th>Στο μενού χρήστη</th><th>Όνομα στο MIS</th><th>Τι επιτρέπει</th></tr>
          </thead>
          <tbody>
            <tr>
              <th>Αναζήτηση &amp; προβολή σχεδίων</th><td>Προβολή Σχεδίων</td>
              <td>Απαραίτητο για να συνδεθείτε· αναζήτηση, λίστα, προβολή σχεδίου.</td>
            </tr>
            <tr>
              <th>Καταχώριση &amp; μαζική καταχώριση</th><td>Σάρωση Σχεδίων</td>
              <td>Καταχώριση σχεδίου και Μαζική καταχώριση. (Η σάρωση γίνεται εκτός εφαρμογής, με το λογισμικό του σαρωτή.)</td>
            </tr>
            <tr>
              <th>Λήψη πρωτοτύπου</th><td>Εκτύπωση Σχεδίων</td>
              <td>Κατέβασμα του αρχικού αρχείου· η εκτύπωση γίνεται μετά, από το κατεβασμένο αρχείο.</td>
            </tr>
            <tr>
              <th>Επεξεργασία &amp; διαγραφή</th><td>Επεξεργασία Σχεδίου</td>
              <td>Αλλαγή των στοιχείων ενός σχεδίου και διαγραφή του.</td>
            </tr>
            <tr>
              <th>Διαχείριση λιστών επιλογών</th><td>Διαχειριστής Εφαρμογής</td>
              <td>Η καρτέλα «Λίστες επιλογών» — και όλα τα παραπάνω.</td>
            </tr>
          </tbody>
        </table>
        <p>
          ...
          Ο διαχειριστής έχει αυτόματα όλα τα υπόλοιπα.
        </p>
        <Shot src="user-menu.png" narrow alt="Μενού χρήστη με τη λίστα δικαιωμάτων"
              caption="Μενού χρήστη: τα πέντε δικαιώματα (εδώ όλα δοσμένα — όσα λείπουν φαίνονται αχνά), θέμα και μέγεθος γραμμάτων" />
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <h3>Διαγραφή</h3>
        <p>
          <Btn>Διαγραφή</Btn> (κόκκινο) ζητά επιβεβαίωση και αφαιρεί το σχέδιο από το αρχείο· παύει να
          εμφανίζεται στις αναζητήσεις. Η ερώτηση επιβεβαίωσης ακυρώνεται με <Btn>Ακύρωση</Btn>, με κλικ
          έξω από το παράθυρό της ή με το πλήκτρο <Kbd>Esc</Kbd>.
        </p>
      </>
    ),
  },
    ...
    body: (
      <>
        ...
        <p>
          ...
          η σελίδα καταχώρισης, με φόρμα σε τρεις ενότητες:
        </p>
        <table className="manual-table">
          <tbody>
        ...
        <ul>
          ...
          <li>Μετά την καταχώριση επιστρέφετε αυτόματα στη λίστα και εμφανίζεται μήνυμα επιβεβαίωσης
            στο πάνω μέρος της οθόνης. Με <Btn>Επιστροφή στη λίστα</Btn> γυρίζετε στη λίστα χωρίς καταχώριση.</li>
          <li>Αν λείπει ο αριθμός σχεδίου ή το αρχείο, το αντίστοιχο πεδίο σημειώνεται με κόκκινο και
            μήνυμα κάτω από αυτό.</li>
          <li>Αν προσπαθήσετε να φύγετε από τη σελίδα ενώ στέλνεται το αρχείο ή έχετε συμπληρωμένα στοιχεία,
            ζητείται επιβεβαίωση ώστε να μη χαθεί η δουλειά σας από ένα κατά λάθος κλικ. Το ίδιο ισχύει και
            στη μαζική καταχώριση.</li>
        ...
        <div className="note-box">
          ...
          αν ανέβηκε λάθος αρχείο, διαγράψτε το σχέδιο και καταχωρήστε το ξανά.
        </div>
      </>
    ),
  },
    ...
    body: (
      <>
        ...
        <p>
          ...
          καταχωρείται ως ξεχωριστό σχέδιο.
        </p>
        <ol className="manual-steps">
          ...
          <li><Btn>Καταχώριση N αρχείων</Btn> — τα αρχεία ανεβαίνουν <strong>ένα-ένα</strong>· η στήλη «Κατάσταση» δείχνει πρόοδο, επιτυχία ή σφάλμα ανά αρχείο. Όταν όλα ολοκληρωθούν, επιστρέφετε αυτόματα στη λίστα· αν κάποιο απέτυχε, παραμένετε στη σελίδα για διόρθωση και επανάληψη.</li>
        </ol>
        <Shot src="mass-import.png" alt="Φόρμα μαζικής καταχώρισης" caption="Μαζική καταχώριση: κοινά στοιχεία και αρχεία με κατάσταση" />
        <ul>
          <li><Btn>Διακοπή</Btn> σταματά μετά το τρέχον αρχείο· ό,τι ολοκληρώθηκε έχει ήδη καταχωρηθεί.</li>
          <li>Αρχεία με σφάλμα μένουν στον πίνακα για διόρθωση και επανάληψη· <Btn>Απόκρυψη καταχωρημένων</Btn> καθαρίζει τα επιτυχημένα.</li>
          <li>Τα σχέδια που καταχωρήθηκαν μαζικά σημειώνονται ως τέτοια στη βάση (MAZIKI_KATAXWRISI).</li>
        </ul>
      </>
    ),
  },
