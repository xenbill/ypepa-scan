    ...
    body: (
      <>
        ...
        <ul>
          ...
          <li>Δεξιά, το ονοματεπώνυμό σας (όπως το δίνει το MIS) ανοίγει μενού με τα <strong>δικαιώματά</strong> σας, την <strong>Εμφάνιση</strong> (φωτεινό/σκοτεινό θέμα), <strong>Αλλαγή κωδικού</strong>, <strong>Αποσύνδεση</strong> και την έκδοση της εφαρμογής.</li>
        </ul>
        ...
        <p>
          ...
          <Btn>Σκοτεινό</Btn> το ορίζουν σταθερά. Η επιλογή θυμάται ανά υπολογιστή/φυλλομετρητή. Η εκτύπωση
