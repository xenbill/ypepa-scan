...
const SECTIONS: Section[] = [
  {
    ...
    body: (
      <>
        ...
        <h3>Δικαιώματα</h3>
        <p>
          Ισχύουν τα <strong>ίδια δικαιώματα με την παλιά εφαρμογή</strong> σάρωσης· τα ορίζουν οι
          διαχειριστές στο σύστημα χρηστών MIS (όχι μέσα από την εφαρμογή). Ό,τι δεν σας επιτρέπεται
          απλώς <strong>δεν εμφανίζεται</strong>:
        </p>
        <ul>
        ...
        <p>
          Για να δείτε τι σας έχει δοθεί, ανοίξτε το <strong>μενού χρήστη</strong> (το όνομά σας, πάνω δεξιά):
        ...
        <div className="note-box">
          ...
          επιλογών»), δεν έχετε το αντίστοιχο δικαίωμα — απευθυνθείτε στον διαχειριστή της εφαρμογής.
        </div>
        <h3>Η κεφαλίδα</h3>
        <ul>
          ...
          <li>Δεξιά, το όνομά σας ανοίγει μενού με τα <strong>δικαιώματά</strong> σας, <strong>Αλλαγή κωδικού</strong>, <strong>Αποσύνδεση</strong> και την έκδοση της εφαρμογής.</li>
        </ul>
        <h3>Αρχική σελίδα</h3>
        <p>
